    ...
    <main className="overflow-x-hidden min-h-screen">
      {!showMainContent ? (
        ...
        <>
          ...
          {/* Tour Section */}
          <section className="tournee w-full my-8 sm:my-12 md:my-16 lg:my-20 bg-[url(/src/img/backgroundTicket.jpeg)] bg-cover bg-center bg-no-repeat rounded-none"  id="tournee">
