...
export default function Header() {
    ...
    return(
        <header className="bg-[url(/src/img/new-cover.jpg)] bg-cover bg-center h-250">
            ...
            <div className="img-title text-center m-10 pt-90 md:m-30">
                <p className="font-bold text-5xl md:text-8xl font-urban">BLACKHOLE</p>
                <span>
                    <p className="font-bold text-4xl md:text-5xl text-amber-400 font-urban text-center"> SUPERETTE</p>
                </span>
